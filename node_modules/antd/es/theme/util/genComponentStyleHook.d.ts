...
export declare const genSubStyleComponent: <ComponentName extends OverrideComponent>(...args: Parameters<typeof genComponentStyleHook<ComponentName>>) => ComponentType<SubStyleComponentProps>;
export {};
