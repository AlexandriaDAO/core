...
# dfx canister snapshot load alex_frontend 00000000000000150000000001f0531c0101 --network ic
...
# alex_frontend
dfx canister stop alex_frontend --network ic
dfx canister snapshot create alex_frontend --replace 00000000000000150000000001f0531c0101 --network ic
dfx canister start alex_frontend --network ic
...
dfx canister snapshot create alex_backend --replace 00000000000000010000000001f0531b0101 --network ic
