...
# For Assets Canister
cargo build --release --target wasm32-unknown-unknown --package assets_canister
candid-extractor target/wasm32-unknown-unknown/release/assets_canister.wasm > src/assets_canister/assets_canister.did
