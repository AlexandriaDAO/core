...
import { idlFactory } from './ugd_frontend.did.js';
export { idlFactory } from './ugd_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.UGD_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ugd_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ugd_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ugd_frontend.did.js")._SERVICE>}
 */
export const ugd_frontend = createActor(canisterId);
