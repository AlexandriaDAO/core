...
import { idlFactory } from './ugd_backend.did.js';
export { idlFactory } from './ugd_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.UGD_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ugd_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ugd_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ugd_backend.did.js")._SERVICE>}
 */
export const ugd_backend = createActor(canisterId);
