...
const SonoraMarketPage: React.FC = () => {
	...
	return (
		<>
			<Helmet>
				<title>Audio Marketplace | Sonora | Alexandria</title>
				<meta name="description" content="Buy and sell audio NFTs from creators worldwide on the Alexandria marketplace." />
			</Helmet>
