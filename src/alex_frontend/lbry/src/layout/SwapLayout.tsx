			...
			{user ? (
				...
				<div className="flex flex-col">
					...
					<h3 className="text-smtabsheading text-center text-muted-foreground font-roboto-condensed">
						Effortlessly Manage and Monitor Your Portfolio.
					</h3>
					<p className="text-center text-muted-foreground font-roboto-condensed">
						You can navigate around and check the Application
						History & Insights. Login to view your balances.
					</p>
				</div>
			)}
