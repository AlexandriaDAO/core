			...
			<div className="col-span-1 flex flex-col gap-4 items-center sticky top-0 h-fit">
				<div className="w-full bg-card rounded-lg border p-5">
					<div className="space-y-4">
						...
						<p className="text-sm text-muted-foreground">
							Discover and purchase book NFTs from creators
							worldwide.
						</p>
				...
				<div className="w-full bg-card rounded-lg border p-5">
					<div className="space-y-4">
						...
						<p className="text-sm text-muted-foreground">
							Purchase book NFTs with ALEX or LBRY tokens and own
							them forever.
						</p>
				...
				{loading ? (
					...
					<div className="flex items-center justify-center py-12">
						<div className="text-center">
							...
							<Button
								onClick={() =>
									refreshMarketBookNFTs(1, 8, false)
								}
								className="mt-4"
								variant="outline"
							>
					...
					<div className="flex items-center justify-center py-12">
						<div className="text-center">
							...
							<p className="text-muted-foreground">
								There are currently no book NFTs listed in the
								marketplace.
							</p>
						</div>
					</div>
