  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        ...
        {
          from: path.resolve(__dirname, "public", "introduction", "index.html"),
          to: path.resolve(__dirname, "dist", "introduction", "index.html"),
        ...
        {
          from: path.resolve(__dirname, "public", "introduction", "styles.css"),
          to: path.resolve(__dirname, "dist", "introduction", "styles.css"),
          noErrorOnMissing: true,
        },
        {
          from: path.resolve(__dirname, "public", "introduction", "particles.css"), // Assuming this is the correct name
          to: path.resolve(__dirname, "dist", "introduction", "particles.css"),
          noErrorOnMissing: true,
        },
        ...
        // Copy other assets from the main public directory
        {
          ...
          globOptions: {
            ...
            ignore: [
              ...
              path.resolve(__dirname, "public", "introduction") + '/**',
            ],
          },
          noErrorOnMissing: true,
        },
