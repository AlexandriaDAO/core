					...
					<div className="space-y-4">
						...
						<div className="pt-2 border-t">
							<p className="text-xs text-muted-foreground">
								<span className="font-medium">{audios.length}</span> of <span className="font-medium">{pagination.totalCount}</span> items shown
							</p>
						</div>
					</div>
				</div>
				...
				{loading ? (
					<div className="flex items-center justify-center py-12">
						<div className="text-center">
							...
							<p className="text-muted-foreground">Loading marketplace audio NFTs...</p>
						</div>
					</div>
				) : error ? (
					<div className="flex items-center justify-center py-12">
						<div className="text-center">
							...
							<Button 
								onClick={() => refreshMarketAudioNFTs(1, 8, false)}
								className="mt-4"
								variant="outline"
							>
								Try Again
					...
					<div className="flex items-center justify-center py-12">
						<div className="text-center">
							...
							<p className="text-muted-foreground">There are currently no audio NFTs listed in the marketplace.</p>
						</div>
					</div>
				) : (
					audios.map((audio) => (
