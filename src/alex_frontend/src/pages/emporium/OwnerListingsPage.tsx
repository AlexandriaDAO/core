...
import { EmporiumActor, IcpLedgerActor, Icrc7Actor } from "@/actors";
...
const OwnerListingsPage = () => {
    ...
    useEffect(() => {
        ...
        dispatch(getListings({actor, owner}));
    }, [actor, owner, page, size, sortByPrice, sortByTime]);
        ...
        <div className="container px-2 flex flex-col gap-10">
            <div className="flex flex-col items-center gap-3 md:gap-6 mx-auto p-5 sm:p-10 w-full max-w-md md:max-w-2xl xl:max-w-[800px]">
                ...
                <div className="flex flex-col items-center gap-1 text-foreground text-center font-syne">
                    <h2 className="m-0 font-semibold text-base sm:text-lg md:text-xl lg:text-2xl">User Listings</h2>
                    <p className="m-0 font-normal text-sm sm:text-base md:text-lg lg:text-xl">Here you will find the list of user NFTs listed for sale</p>
                </div>
            </div>
            ...
            {loading ? (
                ...
                <div className="text-center py-12">
                    {owner ? (
                        <p className="text-muted-foreground text-lg">This user doesn't have any NFTs listed for sale.</p>
                    ) : (
