...
import { getAssetList, getCallerAssetCanister, getCanisterCycles, syncNfts, syncProgressInterface } from "@/apps/Modules/shared/state/assetManager/assetManagerThunks";
...
const HomePage: React.FC = () => {
  ...
  const sync = () => {
    if (!user?.principal || !assetManager.userAssetCanister) return;
    dispatch(syncNfts({
  ...
  useEffect(() => {
    ...
    if (assetManager.userAssetCanister&&!assetManager.isLoading) {
