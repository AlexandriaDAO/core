...
const AppCard: React.FC<AppCardProps> = ({ app, size = 'default', className }) => {
  ...
  const cardContent = (
    <div className={cn(
      ...
      <div className={cn(
        ...
        isSmall ? "w-12 h-12" : "w-[100px] md:w-[120px] h-[100px] md:h-[120px]", // Adjust size for small/default/mobile isn't handled here yet
