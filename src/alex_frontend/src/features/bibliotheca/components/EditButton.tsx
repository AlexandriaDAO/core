...
import { setEditing } from "../shelfSlice";
...
export const EditButton: React.FC<EditButtonProps> = ({ item, currentPrice, tokenId }) => {
    ...
    const editing = useAppSelector((state) => state.bibliotheca.shelf.editing);
            ...
            {isOpen && (
                <Dialog open={true}>
                    <DialogContent className="sm:max-w-[425px]" closeIcon={null}>
                        <DialogHeader>
                            <DialogTitle>Edit Book NFT Price</DialogTitle>
                            <DialogDescription>
                                Set a new price for your book NFT.
                            </DialogDescription>
                        </DialogHeader>
                        {error && (
