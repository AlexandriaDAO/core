        ...
        <>
            ...
            <div className='container px-3'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    ...
                    <LineChart name='ALEX Rate' dataXaxis={chartData.chartData.map((data) => data.time)} dataYaxis={chartData.chartData.map((data) => data.alexRate)} lineColor={'#00ccff'} gardientColor={' #b3f0ff'} />
