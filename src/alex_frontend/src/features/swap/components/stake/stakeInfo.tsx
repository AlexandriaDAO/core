...
const StakedInfo: React.FC<LbryRatioProps> = ({ actorSwap, isAuthenticated }) => {
    ...
    useEffect(() => {
        ...
        dispatch(getALlStakesInfo({ actor: actorSwap }))
    }, [auth.user])
    useEffect(() => {
                    ...
                    <tr className="border-b border-gray-300 hover:bg-gray-100">
                        ...
                        <th className="py-3 px-6 text-left">
                            <div className='stake-table whitespace-nowrap'>
                                <ClaimReward actorSwap={actorSwap} />
                                <Unstake actorSwap={actorSwap} />
                            </div>
                        </th>
                    </tr>
                </tbody>
