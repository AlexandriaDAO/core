...
import { reset, setContentType, setFileSelector, setTextEditor, ContentType } from "../pinaxSlice";
...
function FileUploader({file, setFile}: FileUploaderProps) {
    ...
    const { type, scanning, estimating, fetching, selecting, uploading, transaction, scanError, lbryFee, paymentStatus } = useAppSelector(state=>state.pinax);
