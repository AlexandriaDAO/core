...
import { FILE_TYPES, allowedTypes, getFileTypeInfo } from "@/features/pinax/constants";
import { formatFileSize } from "@/features/pinax/utils";
import { ChevronDown, ChevronUp, CircleAlert } from "lucide-react";
import { setFileSelector } from "../pinaxSlice";
...
function FileSelector({ setFile }: FileSelectorProps) {
    ...
    const { fileSelector } = useAppSelector(state => state.pinax);
