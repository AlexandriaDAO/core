...
const Asset = () => {
	...
	const handleAssetSubmit = async() => {
        try {
            ...
            const tx = await createFileTransaction(image, irys);
	...
	return (
        <div className="flex flex-col gap-2">
            <OpagueHolder loading={loading}>
                ...
                <AssetPreview type={AssetType.Image} asset={image} onDelete={handleDeleteFile} />
            </OpagueHolder>
            ...
            <footer className="flex justify-between items-center">
				<div className="flex justify-start gap-2 items-center">
                    {loading ?
                        ...
                        <Button onClick={handleAssetSubmit} type="button" disabled={!image} variant={!image ? "inverted" : "info"}>
                            Next
                        </Button>
                    }
					<Button
