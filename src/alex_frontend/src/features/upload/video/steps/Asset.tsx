...
const Asset = () => {
	...
	const handleAssetSubmit = async() => {
        try {
            ...
            const tx = await createFileTransaction(video, irys);
	...
	return (
        <div className="flex flex-col gap-2">
            <OpagueHolder loading={loading}>
                ...
                <AssetPreview type={AssetType.Video} asset={video} onDelete={handleDeleteFile} />
            </OpagueHolder>
            ...
            <footer className="flex justify-between items-center">
				<div className="flex justify-start gap-2 items-center">
                    {loading ?
                        ...
                        <Button onClick={handleAssetSubmit} type="button" disabled={!video} variant={!video ? "inverted" : "info"}>
                            Next
                        </Button>
                    }
					<Button
