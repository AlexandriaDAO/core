...
import { setCursor, setVideos } from "./assetSlice";

const MyVideos = () => {
	const dispatch = useAppDispatch();
	const { videos, loading, error } = useAppSelector((state)=>state.asset);
	...
	if(videos.length<=0) return <span>No Video Uploaded</span>
