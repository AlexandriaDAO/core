    ...
    >
      <CardContent className="flex flex-col items-start p-0">
        <AspectRatio ratio={1} className="w-full relative">
          <div className={`flex items-center justify-center bg-gray-50 dark:bg-gray-800 rounded-2xl  ${component==="Emporium"?" border-gray-900 dark:border-gray-900 rounded-2xl":"overflow-hidden h-full "}`}  >
            {children}
          </div>
