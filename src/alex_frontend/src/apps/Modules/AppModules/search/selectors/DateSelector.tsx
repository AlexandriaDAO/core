  ...
  return (
    <div className="flex gap-3">
      <div className="flex flex-col justify-center items-start gap-3 flex-1">
        ...
        <div className="flex h-[50px] px-5 justify-center items-center gap-[33px] self-stretch rounded-[30px] border border-[#F3F3F3] bg-white">
          <input
            type="date"
            value={searchState.filterDate}
            onChange={(e) => handleDateTimeChange('date', e.target.value)}
            className="flex-1 text-black font-['Poppins'] text-base font-light bg-transparent border-none outline-none"
          />
          <button
