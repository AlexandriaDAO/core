            ...
            <div className="container px-2">
                <div className="lg:pb-10 md:pb-8 sm:pb-6 xs:pb-4">
                        <Button
                            className={
                                `
                                lg:h-10 xs:h-10 lg:px-7 xs-px-5 text-[#353535] lg:text-xl md:text-lg sm:text-base xs:text-sm border border-2 border-[#353535] rounded-[10px] lg:me-5 md:me-3 xs:me-2 hover:bg-gray-900 mb-2 
                                
                                ${activeButton === "userNfts" ? "dark:text-[#0F172A] dark:bg-[#FFFFFF] dark:border-2 dark:border-[#FFFFFF] text-[#FFFFFF] bg-gray-900" : ""
                                }`}
                        ...
                        <Button
                            className={
                                `
                                lg:h-10 xs:h-10 lg:px-7 xs-px-5 text-[#353535] lg:text-xl md:text-lg sm:text-base xs:text-sm border border-2 border-[#353535] rounded-[10px] lg:me-5 md:me-3 xs:me-2 hover:bg-gray-900 hover:text-white mb-2
                                
                                ${activeButton === "marketPlace" ? "dark:text-[#0F172A] dark:bg-[#FFFFFF] dark:border-2 dark:border-[#FFFFFF] text-[#FFFFFF] bg-gray-900" : ""
                                }`}
                            onClick={() => {
                                fetchMarketListings();
                            }}
                        ...
                        <Button
                            className=
                            {
                                `lg:h-10 xs:h-10  lg:px-7 xs-px-5 text-[#353535] lg:text-xl md:text-lg sm:text-base xs:text-sm border border-2 border-[#353535] rounded-[10px] lg:me-5 md:me-3 xs:me-2 hover:bg-gray-900 hover:text-white
