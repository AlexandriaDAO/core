...
import {
	...
	getAssetList,
	syncNfts,
	syncProgressInterface,
	getCanisterCycles,
} from "../state/assetManager/assetManagerThunks";
import { LoaderPinwheel } from "lucide-react";
import { Button } from "@/lib/components/button";
import { Description, FiltersButton } from "@/apps/Modules/shared/styles";
...
const AssetManager = () => {
	...
	const [userAssetCanister, setUserAssetCanister] = useState<string | null>(
		null
	);
...
"
				...
				<div className="p-0 max-w-md w-full text-center">
					...
					<p className="text-lg text-gray-600 mb-4">
						<span className="font-mono font-semibold text-[#7F8EA3]">
							{assetManager.userAssetCanister}
						</span>
					</p>
					<Button
				...
				<div className="w-full max-w-md space-y-3 mt-6">
					...
					<div className="w-full bg-gray-200 rounded-full h-2.5">
						<div
							...
							style={{
								width: `${syncProgress.currentProgress ?? 0}%`,
							}}
						/>
					</div>
