...
export const BlogMarkdownDisplay = ({
	content,
	onClick,
}: {
	content: string;
	...
	<div
		className="blog-markdown-content cursor-pointer font-serif"
		onClick={onClick}
	>
	...
	<ContentCard
		...
		footer={
			<div className="flex flex-wrap items-center gap-1 font-serif">
				...
				<Badge
					variant="outline"
					className="text-[10px] py-0.5 px-1 bg-white/50 dark:bg-gray-800/50"
				>
					{shelfId}
				</Badge>
			</div>
