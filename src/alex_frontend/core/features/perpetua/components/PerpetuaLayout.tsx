...
export default function PerpetuaLayout() {
	...
	const userMatch = useMatch({ from: "/_auth/app/perpetua/user/$userId/", shouldThrow: false });
	const userShelfMatch = useMatch({ from: "/_auth/app/perpetua/user/$userId/shelf/$shelfId", shouldThrow: false });
