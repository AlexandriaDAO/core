...
function PerpetuaFallback({ error, resetErrorBoundary }: FallbackProps) {
	return (
...
export default function PerpetuaErrorBoundary({ children }: { children: React.ReactNode }) {
	return (
		<ErrorBoundary FallbackComponent={PerpetuaFallback}>
			{children}
		</ErrorBoundary>
	);
}
