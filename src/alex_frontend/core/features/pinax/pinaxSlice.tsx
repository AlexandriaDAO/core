...
import getLockedLbryBalance from "../balance/lbry/thunks/locked";
	...
	extraReducers: (builder: ActionReducerMapBuilder<PinaxState>) => {
		builder
			...
			.addCase(
				...
				(state, action: PayloadAction<SerializedWallet[]>) => {
			...
			.addCase(
				...
				(
					state,
					action: PayloadAction<{ cost: string; fee: number }>
				) => {
			...
			.addCase(getLockedLbryBalance.fulfilled, (state) => {
