...
import { setContentType, setTextEditor, setFileSelector, setPostUploadPreview } from "@/features/pinax/pinaxSlice";
import { Button } from "@/lib/components/button";
import { ContentType } from "@/features/pinax/pinaxSlice";
import { Step } from "@/features/pinax/pinaxSlice";

function Header() {
	const dispatch = useAppDispatch();
	const { type, step, fetching, selecting, uploading } = useAppSelector(state => state.pinax);
