...
// // import CandyTypes "mo:candy_0_3_0/types";
...
// // // Previous working version with old types.
// //   // private func icrcX_update_nft(caller: Principal, request: ICRC7.UpdateNFTRequest) : async Result.Result<[ICRC7.UpdateNFTResult], Text> {
// //   //   icrc7().update_nfts<system>(caller, request)
// //   // };


// // // Define the authorized principal at the top of your actor
// // let AUTHORIZED_PRINCIPAL : Principal = Principal.fromText("2jgt7-v33z4-tiosh-csi2v-66cge-4uu7j-v2nye-z27vc-d36pc-ctqai-bqe"); // Replace with the actual principal

// // // Define types based on your NFT format
// // type MetadataValue = {
// //   #Text : Text;
// //   #Nat : Nat;
...
// // type ShareableUpdateNFTRequest = {
// //   token_id : Nat;
// //   metadata : [MetadataProperty];
// // };

// // // Keep the original function private with system capability
// // private func icrcX_update_nft<system>(caller: Principal, request: ShareableUpdateNFTRequest) : Result.Result<(), Text> {
// // // Replace with real logic
// //   #ok(())
// // };

// // // Create a new public wrapper function with system capability
// // public shared(msg) func public_icrcX_update_nft<system>(request: ShareableUpdateNFTRequest) : async Result.Result<(), Text> {
// //   if (msg.caller != AUTHORIZED_PRINCIPAL) {
// //     return #err("Unauthorized: Only the specified principal can call this function");
// //   };
  
// //   // Call the private function
// //   switch (icrcX_update_nft<system>(msg.caller, request)) {
// //     case (#ok(_)) #ok();
// //     case (#err(e)) #err("Update failed: " # e);
// //   }
// // };
...
// // let AUTHORIZED_PRINCIPAL : Principal = Principal.fromText("2jgt7-v33z4-tiosh-csi2v-66cge-4uu7j-v2nye-z27vc-d36pc-ctqai-bqe");

// // public type UpdateNFTRequest = {
// //   token_id : Nat;
// //   updates : [CandyTypes.PropertyUpdate];
// // };

// // public shared(msg) func update_nft_metadata(request: UpdateNFTRequest) : async Result.Result<(), Text> {
// //   if (msg.caller != AUTHORIZED_PRINCIPAL) {
// //     return #err("Unauthorized: Only the specified principal can call this function");
// //   };
...
// //   switch (icrc7().update_nfts<system>(msg.caller, [update_request])) {
// //     case (#ok(_)) #ok();
// //     case (#err(error)) #err("Update failed: " # error);
// //   }
// // };
...
// // // Request type for updating NFT metadata
// // type UpdateNFTRequest = {
// //   token_id : Nat;
// //   updates : [PropertyShared];
// // };

// // // Add this type if it's not already defined in your ICRC7 implementation
...
// // // Define the types based on the ICRC7 implementation
// // type UpdateNFTItemRequest = {
// //   token_id: Nat;
// //   updates: [CandyTypes.PropertyUpdate];
// //   memo: ?Blob;
// //   created_at_time: ?Nat64;
...
// // type UpdateNFTRequest = [UpdateNFTItemRequest];
...
// // public shared(msg) func update_nft_metadata(request: UpdateNFTItemRequest) : async Result.Result<[UpdateNFTResult], Text> {
// //   let update_request : UpdateNFTRequest = [request];
...
// //   created_at_time : ?Nat64;
// //   token_id: Nat;
// //   updates: [CandyTypes.Update];
// // };

// // public shared(msg) func update_nft_metadata(request: UpdateNFTRequest) : async Result.Result<[ICRC7.UpdateNFTResult], Text> {
// //   // Check if the caller is authorized
// //   if (msg.caller != icrc7().get_state().owner) {
// //     return #err("Unauthorized: Only the owner can update NFT metadata");
// //   };

// //   // Call the update_nfts function from the ICRC7 module
// //   // The request is already in the correct format, so we can pass it directly
// //   try {
// //     let result = icrc7().update_nfts<system>(msg.caller, request);
// //     #ok(result)
// //   } catch (error) {
