// // OG default demo response with canid
...
// #[ic_cdk_macros::query]
// fn get_all_message_cards() -> Vec<(String, MessageCard)> {
//     MESSAGE_CARDS.with(|cards| {
//         cards.borrow()
//             .iter()
//             .map(|(user_query, card)| (user_query.clone(), card.clone()))
//             .collect()
//     })
// }
...
// #[ic_cdk_macros::query]
// fn get_all_message_cards() -> Result<Vec<(String, MessageCard)>, String> {
//     MESSAGE_CARDS.with(|cards| {
//         cards.borrow()
//             .iter()
//             .map(|(user_query, card)| {
//                 // Clone the data to avoid using `unwrap()`
//                 let cloned_query = user_query.clone();
//                 let cloned_card = card.clone();
//                 Ok((cloned_query, cloned_card))
//             })
//             .collect() // This will collect results into a Result<Vec<_>, _>
//     })
// }
