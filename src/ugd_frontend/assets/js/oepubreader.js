...
class Toolbar {
	...
	constructor(reader) {
		...
		document.getElementById('ReaderRoot').appendChild(container.dom);
...
class Sidebar {
	...
	constructor(reader) {
		...
		document.getElementById('ReaderRoot').appendChild(this.container.dom);
	}
}
...
class Content {
	...
	constructor(reader) {
		...
		document.getElementById('ReaderRoot').appendChild(this.main.dom);
