...
const SearchBar = ({ selectedAuthors, setSelectedAuthors, selectedCategories, setSelectedCategories }) => {
  ...
  const { authors } = useAuthors(); // Use the hook to get the authors

  const allCategories = [...new Set(authors.flatMap(author => author.category))]; // Replace AUTHOR_INFO with authors
